Shader "FluidSim/Divergence" 
{
	SubShader 
	{
    	Pass 
    	{
			...
			{
				float4x4 cardinals = GetCardinal(IN.uv, _InverseSize, _Obstacles, _Velocity, 0);
				
    			// Why 0.5? No clue. Cardinal values found in GetCardinal. East.x - West.x + North.y - South.y
    			float result = _HalfInverseCellSize * (cardinals._21 - cardinals._41 + cardinals._12 - cardinals._32);
